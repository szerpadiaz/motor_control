...
#define R_NOMINAL               __float_reg[7]                                  // Nominal motor resistance, set during calibration (MOTOR CONFIG)
#define TEMP_MAX                __float_reg[8]                                  // Temperature safety lmit
#define I_MAX_CONT              __float_reg[9]                                  // Continuous max current
#define PPAIRS					__float_reg[10]									// Number of motor pole-pairs (MOTOR CONFIG)
//#define L_D						__float_reg[11]									// D-axis inductance
//#define L_Q						__float_reg[12]									// Q-axis inductance
#define R_PHASE					__float_reg[13]									// Single phase resistance (MOTOR CONFIG)
#define KT						__float_reg[14]									// Torque Constant (N-m/A): N-m per peak phase amp, = WB*NPP*3/2 (MOTOR CONFIG)
#define R_TH					__float_reg[15]									// Thermal resistance (C/W) (MOTOR CONFIG)
#define C_TH					__float_reg[16]									// Thermal mass (C/J)
#define GR						__float_reg[17]									// Gear ratio (MOTOR CONFIG)
